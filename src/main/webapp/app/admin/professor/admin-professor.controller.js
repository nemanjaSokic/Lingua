(function() {
    ...
    AdminProfessorController.$inject = ['$rootScope', '$scope', '$uibModal', 'courses', 'profService', 'ProfessorService', '$log', '$location'];

    function AdminProfessorController ($rootScope, $scope, $uibModal, courses, profService, ProfessorService, $log, $location) {
        var vm = this;
        vm.prof = profService;
